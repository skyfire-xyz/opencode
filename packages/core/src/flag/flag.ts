...
export const Flag = {
  ...
  // KYA / Skyfire integration
  OPENCODE_KYA_CREATE_TOKEN_URL: process.env["OPENCODE_KYA_CREATE_TOKEN_URL"],
  OPENCODE_SKYFIRE_API_KEY: process.env["OPENCODE_SKYFIRE_API_KEY"],
